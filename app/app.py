...
app.mount("/admin/css/admin", StaticFiles(directory="static/css"), name="admin-csc")
app.mount("/admin/js/admin", StaticFiles(directory="static/js"), name="admin-js")
app.mount("/admin/img/", StaticFiles(directory="static/img"), name="admin-js")
